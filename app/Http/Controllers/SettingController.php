...
class SettingController extends Controller
{
    public function index(Request $get, $id = 0)
    {
        ...
        $data['user']->aadharcard = 'XXXX-XXXX-' . substr(@$data['user']->aadharcard, -4);
    ...
    public function profileUpdate(Request $post)
    {
        ...
        switch ($post->actiontype) {
            ...
            case 'bankdata':
                ...
                $getUserBanks = DB::table('user_banks')->where('user_id', $insert['user_id'])->update(['status' => "inactive"]);
            ...
            case 'certificate':
                $post['bene_id1'] = json_encode(['cmo' => $post->cmo, "coo" => $post->coo]);
        }
