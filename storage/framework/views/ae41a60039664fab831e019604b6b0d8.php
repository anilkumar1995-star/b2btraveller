    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="card card-default">
                ...
                <form id="serachForm" action="<?php echo e(route('dmtxpay')); ?>" method="post">
                    ...
                    <input type="hidden" name="ccpayte" value="ccpayout">
                    <input type="hidden" id="rname">
                    <input type="hidden" id="rlimit">
                    <div class="card-body">
                         <h4 class="card-title">Move CC Fund To Bank</h4>
        ...
        <div class="col-sm-8">
            <div class="card card-default">
                ...
                <div class="card-body">
                      <h4 class="card-title">Beneficiary List  -  AVL. BAL. <?php echo e(Auth::user()->ccwallet); ?> /-   <a style="float: right" href="" class="btn btn-success text-white btn-sm" data-bs-toggle="offcanvas" data-bs-target="#fundRequestModalsRunpaisa">
                            <i class="ti ti-plus ti-xs"></i> Move to Wallet</a> </h4>
            ...
            <div class="row">
                 <div class="form-group col-md-12 my-1 my-1">
                    ...
                    <select name="type" id="mySelect" class="form-control my-1" required>
                        ...
                        <option value="ccwallet">Move To Main Wallet</option>
                    </select>
                </div>
                <div class="form-group col-md-12 my-1 my-1">
                                ...
                                success: function(data){
                                    ...
                                    if(data.status == 'ERR')
                                    {
                                        ...
                                        if(data.statuscode == "TXN" || data.statuscode == "TUP"){
                                            ...
                                            out += '<li class="list-group-item alert alert-success no-margin mb-10"><strong>Rs.'+amount +'  </strong><span class="pull-right"> '+ data.status+'</span></li>';
                                            tbody += `
                                                <tr>
                                                    <td>`+data.data.payid+`</td>
                                            ...
                                            out += '<li class="list-group-item alert alert-danger no-margin mb-10"><strong>Rs.  '+amount+'</strong><span class="pull-right">'+data.status+'</span></li>';
                                        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/service/ccpayout.blade.php ENDPATH**/ ?>