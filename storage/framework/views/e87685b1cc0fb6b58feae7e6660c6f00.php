...
<div class="modal fade bd-example-modal-xl" id="ccbillModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Crecit Card Bill Payments</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <form class="commissionForm" method="post" action="<?php echo e(route('resourceupdate')); ?>">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered m-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $ccbillOperator; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <input type="hidden" name="slab[]" value="<?php echo e($element->id); ?>">
                                    <?php echo e($element->name); ?>
        ...
        var options = [{
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    menu += `<a href="javascript:void(0)"  class="dropdown-item" onclick="commission(` + full.id + `, 'crdircardbill','ccbillModal')">Credit Crard Bill</a>`;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.quick2pay.in/resources/views/resource/scheme.blade.php ENDPATH**/ ?>