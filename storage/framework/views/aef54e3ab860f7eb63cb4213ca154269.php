...
<div class="offcanvas offcanvas-end" id="utiidModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
            ...
            <div class="offcanvas-header bg-primary">
                <h5 class="text-white" id="exampleModalLabel">Uti Id Details</h5>
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `<div class="btn-group" role="group">
                                    <span id="btnGroupDrop1" class="badge ${full.status=='success'? 'badge-success bg-success' : full.status=='pending'? 'badge-warning bg-warning':full.status=='reversed'? 'badge-info bg-info':full.status=='refund'? 'badge-dark bg-dark':'bg-danger badge-danger'} dropdown-toggle"  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ` + full.status + `
                                    </span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.bharatmitra.co/resources/views/statement/recharge.blade.php ENDPATH**/ ?>