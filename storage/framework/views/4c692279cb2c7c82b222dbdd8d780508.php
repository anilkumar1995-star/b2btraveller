<?php $__env->startSection('title', "wallet to wallet Statement"); ?>
<?php $__env->startSection('pagetitle',  "wallet to wallet Statement"); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if(number != ''){
            $.ajax({
                url: '<?php echo e(route("getmember")); ?>',
                type: 'post',
                dataType: 'json',
                headers: {
        ...
        var url = "<?php echo e(url('statement/fetch')); ?>/wallet2walletstatement/0";
        var onDraw = function() {};
        var options = [
            { "data" : "name",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.bharatmitra.co/resources/views/fund/wallet2walletstatement.blade.php ENDPATH**/ ?>