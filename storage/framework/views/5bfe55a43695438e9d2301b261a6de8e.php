                            ...
                            <div class="">
                                <ul class="nav nav-tabs nav-pills" role="tablist">
                                    ...
                                    <?php if(\Myhelper::hasRole('admin')): ?>
                                        ...
                                        <li class="nav-item">
                                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                                data-bs-target="#navs-justified-capping"
                                                aria-controls="navs-justified-capping" aria-selected="false">
                                                Amount Capping
                                            </button>
                                        </li>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\login.bharatmitra.co\login.bharatmitra.co\resources\views/profile/index.blade.php ENDPATH**/ ?>