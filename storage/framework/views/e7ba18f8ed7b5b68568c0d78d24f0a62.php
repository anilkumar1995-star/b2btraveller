        ...
        <div class="card-body mt-3">
            <div class="ticket-route w-100 p-3 mb-4">
                ...
                <div class="row mb-4 alert alert-warning">
                    <div class="col-md-3"><b>Booking ID:</b> <?php echo e($booking->booking_id_api); ?></div>
                    <div class="col-md-3 text-center border-start border-primary"><b>PNR:</b> <?php echo e($booking->pnr); ?></div>
                    <div class="col-md-3 text-center border-start border-primary"><b>Journey:</b>
                        <?php echo e($booking->journey_type); ?>
                    ...
                    <div class="col-md-3 text-end border-start border-primary"> <b>Sector:</b>
                        ...
                        ?>
                        <?php echo e($finalDet['Origin']); ?> →
                        <?php echo e($finalDet['Destination']); ?></div>
                </div>
                        ...
                        <?php dd($p['Ticket']['TicketId']); ?>;
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label">
                                    <?php echo e($p['Title']); ?> <?php echo e($p['FirstName']); ?> <?php echo e($p['LastName']); ?>

                                    <span class="badge bg-label-info">🎟️ <?php echo e($p['Ticket']['TicketId']); ?></span>
                                </label>
                            </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        $('#cancelNow').on('click', function() {
            ...
            const payload = {
                BookingId: <?php echo e($booking->booking_id_api); ?>,
                RequestType: Number(requestType),
                CancellationType: Number(cancellationType),
                TicketId: tickets,
                Remarks: remarks,
                Sectors: [{
                    Origin: "<?php echo e($finalDet['Origin']); ?>",
                    Destination: "<?php echo e($finalDet['Destination']); ?>"
                }],
            };
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\flight_b2b_travel\flight_b2b_travel\resources\views/flight/cancel.blade.php ENDPATH**/ ?>