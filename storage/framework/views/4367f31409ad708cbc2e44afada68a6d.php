            ...
            <div class="modal-body">
                <div id="receptTable">
                          ...
                          <thead class="thead-light">
                            <tr>
                                ...
                                <th style="padding: 0px 0px 5px 0px; text-align: right; margin-right:10px">
                                    ...
                                    <img src="<?php echo e(Imagehelper::getImageUrl().Auth::user()->company->logo); ?>" class="img-responsive" alt="" style="width: 60px;height: 40px;">
                                    <?php else: ?>
                            ...
                            <tr>
                                <td style="padding: 10px 0px">
                                    <address class="m-b-10 ">
                                        <strong>Agent :</strong> <span class="agentname"></span><br>
                                        <strong>Phone :</strong> <span class="mobile"></span><br>
                                        <strong>Shop Name :</strong> <span class="shopname"></span>
                                    </address>
                                </td>
                                <td style="padding: 10px 0px" class="text-right">
                                    <address class="m-b-10">
                                        <strong>Consumer No. : </strong> <span class="option1"></span><br>
                    ...
                    <div class="row" style="border-radius: 0px;">
                        <div class="col-md-6 col-md-offset-6 mt-2">
                            <h5 class="text-right">Bill Amount : <span class="amount"></span></h5>
                        </div>
                    </div>
                   
                 </div>
                 <button class="btn btn-primary float-end" type="button" id="print"><i class="fa fa-print"></i></button>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        var options = [{
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    return full.amount;
                   // return `Amount - <i class="fa fa-inr"></i> ` + full.amount + `<br>Profit - <i class="fa fa-inr"></i> ` + full.profit + `<br>Charge - <i class="fa fa-inr"></i> ` + full.charge;
                }
            },
            {
                "data": "profit"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/statement/billpay.blade.php ENDPATH**/ ?>