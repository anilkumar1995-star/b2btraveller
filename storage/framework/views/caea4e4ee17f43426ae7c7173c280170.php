    ...
    $(document).ready(function() {
        ...
        var options = [{
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    return `<i class="fa fa-inr"></i> ` + full.closing_balance;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.bharatmitra.co/resources/views/statement/account.blade.php ENDPATH**/ ?>