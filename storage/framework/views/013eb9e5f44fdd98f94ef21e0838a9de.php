...
<?php $__env->startSection('pagetitle', "Credit Card Payment History "); ?>
            ...
            },
              {
                ...
                render: function(data, type, full, meta) {
                     ...
                     if (full.settlementstatus == "success") {
                            ...
                            if(full.route == "easebuzz" && full.status == "success"){
                                 out += `<span class="badge badge-warning bg-warning">Pending</span></br> Credit in <?php echo e($sattelment); ?>`;
                            }else{
            ...
            
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    menu += `<li><a href="javascript:void(0)" class="dropdown-item print"><i class="icon-info22"></i>Print Invoice</a></li>`;
                       menu += `<li><a href="javascript:void(0)" class="dropdown-item" onclick="complaint(` + full.id + `, 'ccpay')"><i class="icon-cogs"></i> Complaint</a></li>`;
                    <?php if(Myhelper::hasrole('admin')): ?>
                     if(full.status != "completed" && full.status == "success"){
                     menu += `<a href="javascript:void(0)" class="dropdown-item"  onclick="transfer('`+full.id+`','`+full.amount+`','`+full.refno+`','`+full.account+`','`+full.ifsc+`')"><i class="icon-info22"></i>Settlement</a>`;
                     }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/statement/ccpay.blade.php ENDPATH**/ ?>