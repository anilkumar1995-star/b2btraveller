                        ...
                        <div class="row row-bordered overflow-visible g-0">
                            ...
                            <div class="dropdown-shortcuts-item col">
                              ...
                              <div class="dropdown-shortcuts-item col">
                                ...
                                <a href="#" class="stretched-link">CC Wallet</a>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('resource', ['type' => 'commission'])); ?>">
...
<!-- / Navbar --><?php /**PATH /home/incognic/login.quick2pay.in/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>