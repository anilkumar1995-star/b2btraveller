...
<script type="text/javascript">
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `<div class="form-check-size"> <div class="form-check form-switch form-check-inline">
                              <input type="checkbox" class="form-check-input custom-control-input apiStatusHandler" id="apiStatus_${full.id}" ${check} value="` + full.id + `" actionType="` + type + `">
    ...
    function editSetup(id, product, name, url, username, password, optional1, code, type, commissiontype, commissionCharge) {
        ...
        $('#setupModal').find('[name="commissiontype"]').val(commissiontype).trigger('change');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.bharatmitra.co/resources/views/setup/api.blade.php ENDPATH**/ ?>