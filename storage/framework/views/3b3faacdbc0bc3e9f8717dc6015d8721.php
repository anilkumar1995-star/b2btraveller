...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <!-- Layout container -->
            <div class="layout-page" style="background:#9dc6ffcc;">
        ...
        <div class="offcanvas offcanvas-end" id="fundRequestModal" tabindex="-1" role="dialog"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="exampleModalLabel">Wallet Fund Request</h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
...
<?php /**PATH C:\wamp64\www\login.bharatmitra.co\login.bharatmitra.co\resources\views/layouts/app.blade.php ENDPATH**/ ?>