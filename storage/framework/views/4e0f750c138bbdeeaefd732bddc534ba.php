                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <address class="m-b-10">
                                                    ...
                                                    <strong>Account No : </strong> <span class="number"></span><br>
                                                     <strong>IFSC : </strong> <span class="option1"></span><br>
                                            ...
                                            <td>
                                                <address class="m-b-10">
                                                   ...
                                                   <strong>Type :</strong> <span>CCPAYOUT</span>
                                                </address>
                                            </td>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(url('statement/fetch')); ?>/ccpayoutstatement/<?php echo e($id); ?>";
        ...
        var options = [{
            ...
            },
            {
                "data": "bank",
                render: function(data, type, full, meta) {
                      return `AC `+full.number + `<br> ifsc ` + full.option1+ `<br> Name ` + full.option2;
            ...
            },
            {
                "data": "bank",
                render: function(data, type, full, meta) {
                    return `Bank Ref - ${(full.refno=='You have Insufficent balance')?'Service is down for some time':full.refno} <br> Txnid - ${full.txnid} <br>Payid -  ${full.payid} `;
                }
            },
            {
                "data": "bank",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/statement/ccpayout.blade.php ENDPATH**/ ?>