...
<?php $__env->startSection('title', 'Booking Search'); ?>
<?php $__env->startSection('pagetitle', 'Booking Search'); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="airlineType1">
                                                <img src="<?php echo e(asset('images/12.svg')); ?>" class="h-15px fa-fw me-2"
                                                    alt="">Blogzine
                                            </label>
                                        </div>
                                        <!-- Checkbox -->
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="airlineType2">
                                                <img src="<?php echo e(asset('images/13.svg')); ?>" class="h-15px fa-fw me-2"
                                                    alt="">Wizixo
                                            </label>
                                        </div>
                                        <!-- Checkbox -->
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="airlineType3">
                                                <img src="<?php echo e(asset('images/14.svg')); ?>" class="h-15px fa-fw me-2"
                                                    alt="">Folio airline
                                            </label>
                                        </div>
                                        <!-- Checkbox -->
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="airlineType4">
                                                <img src="<?php echo e(asset('images/15.svg')); ?>" class="h-15px fa-fw me-2"
                                                    alt="">Booking
                                            </label>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\flight_b2b_travel\flight_b2b_travel\resources\views/flight/index-flight.blade.php ENDPATH**/ ?>