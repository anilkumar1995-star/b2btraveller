...
<head>
    ...
    <title>
        <?php echo e(json_decode(app\Models\Company::where('website', $_SERVER['HTTP_HOST'])->first(['companyname']))->companyname); ?>
                    ...
                    <div class="form_side">
                        <div class="top_image">
                            ...
                            <form name="form1" action="" method="post" id="deleteaccountform">
                                    ...
                                    <input type="hidden" name="id" value="<?php echo e(@Auth::user()->role->id); ?>"/>
                                    ...
                                    <div class="form-check my-3">
                                        ...
                                        <label class="form-check-label" for="flexCheckChecked">
                                            By clicking "CONTINUE", I authorise <?php echo e(json_decode(app\Models\Company::where('website', $_SERVER['HTTP_HOST'])->first(['companyname']))->companyname); ?> to securely store & 
    ...
    $("#deleteaccountform").validate({
        ...
        submitHandler: function(form) {
            if ($('#flexCheckChecked').is(":checked")) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('customer_info_delete')); ?>",
...
<?php /**PATH /home/incognic/login.ismartpay.in/resources/views/deleteaccount.blade.php ENDPATH**/ ?>