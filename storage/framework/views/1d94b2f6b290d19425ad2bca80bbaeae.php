                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                        ...
                        <div class="form-group col-md-6 my-1">
                            ...
                            <input type="text" class="form-control my-1" autocomplete="off" name="name" placeholder="Enter Your Firstame" value="" required>
                        </div>
                        <div class="form-group col-md-6 my-1">
                            <label>Mobile <span class="text-danger fw-bold">*</span></label>
                            <input type="text" pattern="[0-9]*" maxlength="10" minlength="10" class="form-control my-1" name="mobile" autocomplete="off" placeholder="Enter Your Mobile" value="" required>
                        </div>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                        ...
                        <div class="form-group col-md-6 my-1">
                            ...
                            <input type="text"   id="expirationDate" class="form-control my-1" pattern="(?:0[1-9]|1[0-2])/[0-9]{2}" oninput="formatExpiryDate(this)" name="expdate" autocomplete="off" maxlength="7" placeholder="MM/YY" required>
                        </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('ccpayments')); ?>" method="post" id="paymentsForm">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="commission" value="0">
                    <input type="hidden" name="setelment" value="instant">
                        ...
                        <!--</div>-->
                         ...
                         <div class="form-group col-md-12 mb-3">
                            ...
                            <select name="route" class="form-control">
                                <option value="payu">PayU (Non Utility) Limit 50000 </option>
                                <option value="unlimit">Unlimit (Non Utility) Limit 20000 </option>
                                <option value="razorpay">Razorpay (Utility) Limit 100000 </option>
                                <option value="easebuzz">Easebuzz (Utility) Limit 100000 </option>
                                <option value="axis">Axis (Freecharge) Utility Limit 50000</option>
                            </select> 
                        </div>
                         <div class="form-group col-md-12 mb-3">
            ...
            $.each(data.carddata , function(index, beneficiary) {
                ...
                out += `<tr>
                 ...
                 if(beneficiary.isVerify == "1"){
                      out +=`<button class="btn btn-primary btn-sm legitRipple" onclick="sendMoney('`+beneficiary.customerId+`','`+beneficiary.accountNo+`','`+beneficiary.cardId+`','`+beneficiary.network+`')"><i class="fa fa-paper-plane"></i>  withdrawal</button>`;
                 }else{
                       out +=`<button class="btn btn-primary btn-sm legitRipple" onclick="verfyMoney('`+beneficiary.customerId+`','`+beneficiary.accountNo+`','`+beneficiary.cardId+`','`+beneficiary.network+`','`+beneficiary.expireDate+`')"><i class="fa fa-paper-plane"></i>  withdrawal</button>`;
...
function deleteBank(id,cardid) {
   ...
   function formatExpiryDate(input) {
            ...
            if (value.length >= 2) {
                value = value.slice(0, 2) + '/' + value.slice(2, 4); // Add slash after the month part
            }
            input.value = value;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/service/ccpay.blade.php ENDPATH**/ ?>