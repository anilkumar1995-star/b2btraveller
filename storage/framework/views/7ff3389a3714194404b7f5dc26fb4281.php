        ...
        <div class="offcanvas-body">
            ...
            <div class="row">
                 ...
                 <div class="form-group col-md-6 my-1 my-1 accountdetails">
                    ...
                    <input type="text" class="form-control my-1" name="accountname" placeholder="Enter Value"  value="<?php echo e(Auth::user()->name); ?>" >
                </div>
                <div class="form-group col-md-6 my-1 my-1 accountdetails">
                ...
                <div class="form-group col-md-6 my-1 my-1 accountdetails">
                    ...
                    <input type="text" class="form-control my-1" name="ifsc" placeholder="Enter Value"  value="<?php echo e(Auth::user()->userbanks['ifscCode']); ?>" >
                </div>
                <div class="form-group col-md-6 my-1 my-1 accountdetails">
                    <label>Bank Name <span class="text-danger fw-bold">*</span></label>
                    <input type="text" class="form-control my-1" name="bank" placeholder="Enter Value"  value="<?php echo e(Auth::user()->userbanks['bankName']); ?>" >
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(url('statement/fetch')); ?>/ccstatement/<?php echo e($id); ?>";
        var onDraw = function() {};
       var options = [{
                "data": "name",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/statement/ccledger.blade.php ENDPATH**/ ?>