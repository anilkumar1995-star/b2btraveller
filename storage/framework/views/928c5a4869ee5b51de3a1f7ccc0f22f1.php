...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <?php if(Auth::user()->kyc == 'verified'): ?>
            ...
            <li class="<?php echo e(Request::is('insights') ? 'active' : ''); ?> menu-item ">
                <a href="<?php echo e(route('insights')); ?>" class="menu-link">
            ...
            <?php if(Myhelper::can(['affiliate_service'])): ?>
                <?php if(Myhelper::hasNotRole('admin')): ?>
                    <li class="menu-item <?php echo e(Request::is('affiliate') ? 'active open' : ''); ?>">
                        ...
                        <ul class="menu-sub <?php echo e(Request::is('affiliate/list') ? 'show' : ''); ?>" id="affser">
                            <?php if(Myhelper::can(['affiliate_service']) && Myhelper::hasNotRole('admin')): ?>
                                <li class="menu-item <?php echo e(Request::is('affiliate/list') ? 'active open' : ''); ?>">
                                    <a href="<?php echo e(url('affiliate/list', ['type' => 'department'])); ?>"
                                        class="menu-link">
            ...
            <?php if(Myhelper::can(['commission_settlement'])): ?>
                <?php if(Myhelper::hasNotRole('admin')): ?>
                    <li
                        ...
                        <ul class="menu-sub <?php echo e(Request::is('fund/aeps') || Request::is('fund/addaccount') || Request::is('fund/aepsrequest') || Request::is('fund/payoutrequest') || Request::is('fund/aepsrequestall') ? 'show' : ''); ?>"
                            id="aepsfund">
...
<!-- / Menu -->
<?php /**PATH C:\wamp64\www\login.bharatmitra.co\login.bharatmitra.co\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>