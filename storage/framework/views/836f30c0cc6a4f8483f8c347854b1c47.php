        ...
        <?php if(isset($table) && $table == 'yes'): ?>
            function datatableSetup(urls, datas, onDraw = function() {}, ele = "#datatable", element = {}) {
                ...
                var options = {
                    ...
                    // dom: '<"d-flex justify-content-between align-items-center mb-1"lfB>rt<"datatable-footer"ip>',
                    processing: true,
                    serverSide: true,
                    stateSave: true,
                    ordering: false,
...
<?php /**PATH C:\wamp64\www\flight_b2b_travel\flight_b2b_travel\resources\views/layouts/app.blade.php ENDPATH**/ ?>