<?php $__env->startSection('title', "UPI Payout Statement"); ?>
<?php $__env->startSection('pagetitle', " UPI Payout Statement"); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(url('statement/fetch')); ?>/upipayoutstatement/<?php echo e($id); ?>";
        ...
        var options = [{
            ...
            },
            {
                "data": "bank",
                render: function(data, type, full, meta) {
                    return `Name - ` + full.option2 + `<br>` + full.number;
                }
            },
            {
                "data": "bank",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/statement/upipayout.blade.php ENDPATH**/ ?>