                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo e($b->id); ?>">
                                      ...
                                      <li>
                                          <a class="dropdown-item cancel-flight" href="javascript:void(0)"
                                              data-bookingidcancel="<?php echo e($b->booking_id_api); ?>"
                                              data-ticketstatus="<?php echo e($b->ticket_status); ?>">
                                              ✈️ Cancel Flight
                                          </a>
                                      </li>
                                  </ul>
            ...
            <div>
                <div class="bg-white p-4 rounded shadow-sm">
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        ...
                        <div class="text-end">
                            <div class="fw-bold">
                                Flight Ticket (${booking.JourneyType == '1' ? 'One-way' : 'Roundtrip'})
                            </div>
                        ...
                        <div class="col-sm-6 p-3 text-center">
                            ...
                            <div>
                                ...
                                ${booking.AirlineTollFreeNo
                                    ? `<a href="tel:${booking.AirlineTollFreeNo}" class="text-primary fw-semibold">📞 ${booking.AirlineTollFreeNo}</a>`
                                    : '-'}
                            </div>
                        </div>
                            ...
                            <div class="passenger-card">
                                ...
                                <div class="row mb-2">
                                    <div class="col-5">
                                        ...
                                        ${p.Nationality}
                                        <span class="badge bg-label-success">${booking.PNR}</span>
