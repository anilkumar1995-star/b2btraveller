        ...
        <div class="card my-3">
           <!-- <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    ...
                    <form action="" method="post" id="redirectForm" class="pull-right">
                        <?php echo e(csrf_field()); ?> 
                        
                        <button type="submit" class="btn btn-primary my-2" data-loading-text="<b><i class='fa fa-spin fa-spinner'></i></b> Submitting"><b><i class=" icon-paperplane"></i></b> Generate Url</button>
                        </form>
                </div>
            </div> -->
            <div class="card-body" style="padding: 0px;">
                <ul class="nav nav-tabs" id="myTab-1" role="tablist" style="margin-right: 0rem;  margin-left: 0rem;">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="true" onclick="AEPSTAB('CD')">Cash Deposite</a>
                    </li>
                    <li class="nav-item"> 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('form#redirectForm').submit(function() {
            var form = $(this);
            $(this).ajaxSubmit({
                dataType: 'json',
                beforeSubmit: function() {
    ...
    $("#aepsTransactionForm").validate({
        ...
        submitHandler: function(element) {
            ...
            var lat = "yes";
            var mobile = $("#aepsTransactionForm").find('[name="mobileNumber"]').val();  
                                ...
                                if (data.status == "TXN" || data.status == "TUP") {
                                    if (data.transactionType != "MS") {
                                        if (data.transactionType == "CW" || data.transactionType == "CD") {
                                            ...
                                            $('#receipt').find('.mobile').text(mobile);
                                            ...
                                            $('#balancemodal').find('.aadhar').text(data.aadhar);
                                             $('#balancemodal').find('.mobile').text(mobile);
                                        ...
                                        // $('#ministatement').find('.mobile').text(mobile);
    ...
    function AEPSTAB(type) {
        ...
        if (type == "CW" || type == "CD" || type == "M" ||  type == "AP") {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/service/aeps.blade.php ENDPATH**/ ?>