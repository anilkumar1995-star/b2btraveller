            ...
            <div class="card border mb-3">
                <div class="card-header mb-3 bg-label-primary recharge-header">
                        <h5 class="mb-0 d-flex align-items-center gap-2">
                            ...
                            <?php echo e(ucfirst($type)); ?> Recharge
                        </h5>
                    </div>
                <div class="card-body">   
            ...
            <div class="card border mb-3">
                 <div class="card-header mb-3 bg-label-primary recharge-header">
                        <h5 class="mb-0 d-flex align-items-center gap-2">
                            ...
                            Recent <?php echo e(ucfirst($type)); ?> Recharge
                        </h5>
                    </div> 
                <div class="card-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wampp\www\b2btraveller\resources\views/service/recharge.blade.php ENDPATH**/ ?>