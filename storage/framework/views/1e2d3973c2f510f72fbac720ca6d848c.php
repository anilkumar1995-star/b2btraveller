...
<div class="row">
    <?php if($vledata && $vledata->status == "failed"): ?>
    <p class="text-danger">Utiid Request is Rejected, <?php echo e($vledata->remark); ?></p>
    <?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered my-2">
                    ...
                    <tr>
                        <td>Username</td>
                        <td><?php echo e(($vledata) ? '' : ''); ?></td>
                        
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td><?php echo e(($vledata) ? $vledata->vlepassword : ''); ?></td>
                    </tr>
                </table>
                ...
                <form id="pancardForm" action="<?php echo e(route('pancardpay')); ?>" method="post">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group my-1">
                            <label>Vle Id</label>
                            <input type="text" class="form-control my-1" name="vleid" value="<?php echo e(($vledata) ? '' : ''); ?>" required="">
                        </div>
                        <div class="form-group my-1">
                            <label>T-Pin</label>
                    ...
                    <div class="card-footer">
                        ...
                        <button class="btn btn-primary" type="submit" data-loading-text="<i class='fa fa-spin fa-spinner'></i> Updating">Pay Now</button>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
    ...
    <div class="col-8 col-xl-8 col-sm-8 order-1 order-lg-2 my-3 mb-lg-0">
        <div class="card">
            <div class="card-header pb-0 d-flex justify-content-between mb-lg-n4 ">
                ...
                <div class="col-sm-4">
                    <?php if(!$vledata || ($vledata && $vledata->status == "failed")): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.quick2pay.in/resources/views/service/uti.blade.php ENDPATH**/ ?>