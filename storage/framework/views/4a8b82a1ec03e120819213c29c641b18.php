...
<div class="offcanvas offcanvas-end" id="transferModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">

            <div class="offcanvas-header bg-primary">
                <div class="text-center mb-3">
                    <h3 class="mb-2 text-white"><?php echo $__env->yieldContent('pagetitle'); ?></h3>
                </div>
    ...
    $(document).ready(function() {
        ...
        var options = [{
                ...
                render: function(data, type, full, meta) {
                    var check = "";
                    if (full.kyc == "pending") {
                        check += `<span class="badge badge-warning bg-warning">Kyc Pending</span>`;
                    } else {
                        check += `<span class="badge badge-success bg-success">Kyc Success</span>`;
                    }
                    return `<div>` + check + `<span class='text-inverse pull-right m-l-10 ms-2'><b>` + full.id + `</b> </span>
            ...
            },
            {
                "data": "action",
                render: function(data, type, full, meta) {
                    return `<button class="btn btn-primary btn-sm" onclick="transfer('` + full.id + `')">Transfer / Return</button>`;
                }
            }
        ];
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.bharatmitra.co/resources/views/fund/tr.blade.php ENDPATH**/ ?>