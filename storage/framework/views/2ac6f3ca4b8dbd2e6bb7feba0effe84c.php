<?php $__env->startSection('title', "DMT Statement"); ?>
<?php $__env->startSection('pagetitle', "DMT Statement"); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <address class="m-b-10">
                                                   ...
                                                   <strong>Bank : </strong> <span class="option3"></span><br>
                                                   <strong>Account No : </strong> <span class="number"></span><br>
                                                   <strong>IFSC : </strong> <span class="option4"></span><br>
                                            ...
                                            <td>
                                                <address class="m-b-10">
                                                   ...
                                                   <strong>Phone :</strong> <span><?php echo e(Auth::user()->mobile); ?></span></br>
                                                   <strong>Type :</strong> <span>XPAYOUT</span>
                                                </address>
                                            </td>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(url('statement/fetch')); ?>/dmtstatement/<?php echo e($id); ?>";
        ...
        var options = [{
            ...
            },
            {
            ...
            },
             {
                "data": "bank",
                render: function(data, type, full, meta) {
                    return `Name - ` + full.option2 + `<br>` + full.option4 + `<br> A/C ` + full.number;
                }
            },
            {
                "data": "bank",
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    return full.amount;
                    r//eturn `Amount - <i class="fa fa-inr"></i> ` + full.amount + `<br>Charge - <i class="fa fa-inr"></i> ` + full.charge + `<br>Profit - <i class="fa fa-inr"></i> ` + parseFloat(full.profit + full.gst) + `<br>Gst - <i class="fa fa-inr"></i>  ${(full.gst== null)?'0':full.gst}`
                }
            },
            {
                "data": "charge"
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    menu += `<a href="javascript:void(0)" class="dropdown-item" onclick="status(` + full.id + `, 'dmt')"><i class="icon-info22"></i>Check Status</a>`;
                    <?php endif; ?>

                    <?php if(Myhelper::can('money_statement_edit')): ?>
                    menu += `<a href="javascript:void(0)" class="dropdown-item" onclick="editReport(` + full.id + `,'` + full.refno + `','` + full.txnid + `','` + full.payid + `','` + full.remark + `', '` + full.status + `', 'dmt')"><i class="icon-pencil5"></i> Edit</a>`;
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/statement/dmt.blade.php ENDPATH**/ ?>