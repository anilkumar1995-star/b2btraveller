            ...
            <div class="offcanvas-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 my-1">
                        <label>Label</label>
                        <input type="text" name="label" step="any" value="<?php echo e(\Auth::user()->shopname); ?>"  class="form-control my-1"
            ...
            <div class="modal-body">
                <div class="row text-center">
                    <div class="col-md-4 mb-3 border-end" id="qrOnlyDownload">
                        <h6 class="fw-bold mb-3"><?php echo e(\Auth::user()->company->companyname); ?> QR Code</h6>
                        <img id="qr-image" src="<?php echo e($dynamicqr->qrcode ?? ""); ?>" alt="QR Code" class="img-fluid rounded border" width="70%"/>
                    </div>

                    <div class="col-md-4 mb-3 border-end">
                        <h6 class="fw-bold mb-5">Account Details</h6>
                        <p><strong class="text-primary">Name </strong> :  <span class="fs-5"><?php echo e($dynamicqr->label ?? ''); ?> </span></p>
                        <p><strong class="text-primary">Virtual A/C </strong> : <span class="fs-5"><?php echo e($dynamicqr->virtualAccountNumber ?? ''); ?></span></p>
                        <p><strong class="text-primary">IFSC </strong> : <span class="fs-5"><?php echo e($dynamicqr->virtualifsc ?? ''); ?></span></p>
                       
                    </div>

                    <div class="col-md-4 mb-3">
                        <h6 class="fw-bold mb-5">VPA Details</h6>
                        <p><strong class="text-primary">VPA </strong> :  <span class="fs-5"><?php echo e($dynamicqr->virtualPaymentAddress ?? ''); ?></span></p>
                         <p><strong class="text-primary">Merchant Code </strong> : <span class="fs-5"><?php echo e($dynamicqr->merchent ?? ''); ?></span></p>
                          <hr class="my-1"/>
                           <h6 class="fw-bold mb-1">Whitelist Account</h6>
                            <p><strong class="text-primary">AC NO</strong> :  <span class="fs-5"><?php echo e($dynamicqr->account ?? ''); ?></span></p>
                             <p><strong class="text-primary">IFSC Code </strong> : <span class="fs-5"><?php echo e($dynamicqr->ifsc ?? ''); ?></span></p>
                         <hr class="my-1"/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/fund/qrrequest.blade.php ENDPATH**/ ?>