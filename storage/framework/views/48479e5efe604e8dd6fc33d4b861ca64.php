...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <b class="text-danger" style="font-size:16px;">
                    <marquee behavior="alternate"><?php echo e($mydata['billnotice']); ?></marquee>
                </b>
                <?php endif; ?>
                <form id="billpayForm" action="<?php echo e(route('billpay')); ?>" method="post">
                    ...
                    <div class="form-group my-3">
                        ...
                        <select class="form-control mb-3" name="provider_id" required="" onchange="SETTITLE()" id="mySelect">
                            ...
                            <option value="<?php echo e($provider->id); ?>"><?php echo e($provider->name); ?> - ( <?php echo e("Coverage: ". strtoupper($provider->billerCoverage)); ?> )</option>
                            <!-- <option value="<?php echo e($provider->billerId); ?>"><?php echo e($provider->name); ?></option> -->
                    ...
                    <div class="form-group mb-2">
                        <label>T-Pin</label>
                        <a href="<?php echo e(url('profile/view?tab=pinChange')); ?>" target="_blank" class="float-end">Generate
                            Or Forgot Pin??</a>
    ...
    <div class="col-sm-12 col-lg-4">
        <div class="card">
            ...
            <img src="<?php echo e(asset('')); ?>logos/billpay.jpeg" height="320px" width="320px">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/incognic/login.ismartpay.in/resources/views/service/billpayment.blade.php ENDPATH**/ ?>