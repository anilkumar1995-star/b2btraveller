                            ...
                            <div class="status-text animate__animated animate__fadeInUp animate__delay-1s" id="statusContent">
                                @if ($status == 'success')
                                    ...
                                    <p class="lead text-muted px-md-4 mb-3 small">
                                        Your payment is successful and your flight ticket has been confirmed.
                                    </p>
                                @elseif ($status == 'failed')
                                    <h1 class="fw-extra-bold mb-2 text-dark fs-3">Payment Failed</h1>
                                    <p class="lead text-muted px-md-4 mb-3 small">
                                        Oops! We couldn't process your payment. Any deducted amount will be refunded
                                        automatically.
                                    </p>
                                @else
                                    <h1 class="fw-extra-bold mb-2 text-dark fs-3">Processing Flight Booking...</h1>
                                    <p class="lead text-muted px-md-4 mb-3 small">
                                        Your payment is successful! We are confirming your flight ticket with the airline.
                                    </p>
