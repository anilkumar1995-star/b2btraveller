...
@section('pagetitle', 'Flight Details')
            ...
            <div class="bg-primary bg-opacity-10 rounded-3 overflow-hidden mt-4 p-4">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-6 col-md-3 text-center order-1">
                        <img src="{{ asset('images/element/11.svg') }}" class="mb-n5" alt="">
                    </div>
                    ...
                    <div class="col-6 col-md-3 text-center order-3">
                        <img src="{{ asset('images/element/10.svg') }}" class="mb-n5" alt="">
                    </div>
                </div>
            </div>
            <!-- Notice board END -->
                    ...
                    <div class="vstack gap-4">
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body p-4 pb-0">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-3">
                                        <!-- Image -->
                                        <img src="{{ asset('images/element/09.svg') }}" class="w-80px mb-3" alt="">
                                        <!-- Title -->
                        ...
                        <div class="card border">
                            ...
                            <div class="card-header d-sm-flex justify-content-sm-between align-items-center">
                                ...
                                <div class="d-flex align-items-center mb-2 mb-sm-0">
                                    <img src="{{ asset('images/13.svg') }}" class="w-30px me-2" alt="">
                        ...
                        <div class="card border">
                            ...
                            <div class="card-header d-sm-flex justify-content-sm-between align-items-center">
                                <!-- Airline Name -->
                                <div class="d-flex align-items-center mb-2 mb-sm-0">
                                    <img src="{{ asset('images/12.svg') }}" class="w-30px me-2" alt="">
                                        ...
                                        <div class="tab-pane fade show active" id="flightlist-tab1" role="tabpanel"
                                            ...
                                            <div class="card border">
                                                ...
                                                <div class="card-header d-flex align-items-center pb-0">
                                                    <img src="{{ asset('images/12.svg') }}" class="w-30px me-2"
                                                        alt="">
                                                    <h6 class="fw-normal mb-0">Wizixo Airline (SA - 1254)</h6>
                                                </div>
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center mb-3 mb-sm-0">
                                <div class="position-relative z-index-1 me-2">
                                    <img src="{{ asset('images/element/05.svg') }}" class="position-relative h-40px"
                                        alt="">
                                    <span
                            ...
                            <div class="card-header">
                                <div class="d-md-flex justify-content-md-between">
                                    ...
                                    <div class="d-flex align-items-center mb-2 mb-md-0">
                                        <img src="{{ asset('images/14.svg') }}" class="w-30px me-2" alt="">
                ...
                <div class="tab-content mb-0" id="flight-pills-tabContent">
                            ...
                            <div class="card-header">
                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                    ...
                                    <div class="d-flex mb-2 mb-sm-0">
                                        <img src="{{ asset('images/element/09.svg') }}" class="w-40px me-2" alt="">
                    ...
                    <div class="tab-pane fade" id="flight-baggage-tab" role="tabpanel"
                        ...
                        <div class="card border">
                            ...
                            <div class="card-header d-flex align-items-center border-bottom">
                                <!-- Title -->
                                <img src="{{ asset('images/element/09.svg') }}" class="h-20px me-1" alt="">
                                <h5 class="card-title mb-0">BOM - CDG</h5>
                            </div>
