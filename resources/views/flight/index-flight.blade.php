                    ...
                    <div class="row g-4 position-relative">
                        ...
                        <div class="tab-content pt-0 px-3" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-one-way" role="tabpanel"
                                ...
                                <input type="hidden" id="OriginCountry">
                            ...
                            <div class="tab-pane fade" id="pills-round-trip" role="tabpanel"
                                ...
                                <input type="hidden" id="RoundOriginCountry">
                                <input type="hidden" id="RoundDestinationCountry">
                                <div class="row g-4">
        ...
        <section class="all_flight_list d-none mt-3">
            ...
            <div class="row">
                ...
                <div class="col-xl-8 position-relative">
                    <ul class="nav nav-tabs mb-3 d-none w-100 sticky-top" style="top: 90px; z-index: 100;"
                        id="roundTabs">
                        <li class="nav-item w-50 rounded">
                            <button class="nav-link active w-100" id="tabDeparture">Departure</button>
                        </li>
                        <li class="nav-item w-50 rounded" id="tabReturnItem">
...
@push('script')
    <script src="{{ asset('') }}js/bookinggflighttrip.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#Origin').on('select2:select', function(e) {
                $('#OriginCountry').val(e.params.data.country_code);
            });

            $('#Destination').on('select2:select', function(e) {
                $('#DestinationCountry').val(e.params.data.country_code);
            });

            $('#roundOrigin').on('select2:select', function(e) {
                $('#RoundOriginCountry').val(e.params.data.country_code);
            });

            $('#roundDestination').on('select2:select', function(e) {
                $('#RoundDestinationCountry').val(e.params.data.country_code);
            });
        });
    </script>
@endpush
