            ...
            <div class="card mb-3">
                ...
                <div class="bg-image pt-4 pb-1 fs-5 px-4" style="background-image: url('public/banner/{{$val->banner->slides}}')">
                    ...
                    <div class="bg-image pt-4 pb-1 fs-5 px-4" style="background-image: url('public/bg.jpg')">
                        ...
                        <button class="btn btn-success text-white btn-lg my-1 investcls-{{$val->id}}" type="button">INVESTED</button>
                        @else
                        <button class="btn btn-warning text-white btn-lg my-1 investcls-{{$val->id}}" onclick="buyInves('{{$val->id}}')" type="button">INVEST</button>
                        @endif
        ...
        $.ajax({
                ...
                if (data.errors != undefined) {
                    // $('#errormessage').text(data.errors[0]);
                         notify(data.errors[0] || "Something went wrong", 'error');
                }
