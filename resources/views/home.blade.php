                ...
                <div class="slider-wrapper" id="sliderWrapper">
                    <div class="sliderR" id="cardSlider">
                        @if (isset($payment) && count($payment) > 0)
                            @foreach ($payment as $account)
                                ...
                                <div class="card shadow-sm border-0  p-3"
                                    style="min-width: 350px; border-radius: 15px;  background-image: url({{ $bgImage }}); background-size: 100%;background-repeat: no-repeat;">
                                    <div class="mb-3">
                                        <img src="{{ $logoImage }}" width="70" height="30" alt="Bank Logo"
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center fw-semibold">
                                            <span
                                                class="text-white">{{ trim(chunk_split($account->virtual_account_number, 4, ' ')) }}</span>
                                            <i class="bi bi-copy copy-icon text-white"
                                                data-value="{{ $account->virtual_account_number }}"
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center fw-semibold">
                                            ...
                                            <i class="bi bi-copy copy-icon text-white" data-value="{{ $account->ifsc }}"
                                                onclick="copyToClipboard(this)"></i>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @if (!isset($payment) || count($payment) < 3)
                            ...
                            @endphp
                            <div class="card shadow-sm border-0 p-3"
                                style="min-width: 350px; border-radius: 15px; background-image: url({{ $bgImage }}); background-size: 100%; background-repeat: no-repeat; position: relative;">
                                ...
                                <a href="{{ route('vanlist') }}"
                                    class="position-absolute top-50 end-0 translate-middle-y me-4 d-flex justify-content-center align-items-center shadow"
                ...
                <div class="card card-border-shadow-danger h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="mb-0" id="total_booking_amount_bus">
                                ₹0
                            </h4>
                        </div>
                        <p class="mb-1"> Confirmed booking value</p>
                        <p class="mb-0">
                            <span class="text-heading fw-bold me-1" id="booking_count_bus">
                                0
                            </span>
                            <small class="text-body-secondary">
                                Total Bus Bookings
