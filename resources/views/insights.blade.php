    ...
    <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
        <div class="card">
            <div class="card-body pb-0">
                ...
                <h5 class="card-title mb-0 mt-2 aepsbalance">{{ Auth::user()->aepsbalance }}</h5>
                ...
                <ul class="p-0 m-0">
                    ...
                    <li class="d-flex mb-4 pb-1 align-items-center">
                        ...
                        <div class="d-flex w-100 align-items-center gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                                <div>
                                    <h6 class="mb-0">Downline Balance Main</h6>
                                </div>
                    ...
                    <li class="d-flex mb-4 pb-1 align-items-center">
                        ...
                        <div class="d-flex w-100 align-items-center gap-2">
                           <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                                <div>
                                    <h6 class="mb-0">Downline Balance CC</h6>
                                </div>

                                
                                <div class="user-progress d-flex align-items-center gap-2">
                                    <h6 class="mb-0 downlinebalancecc">0</h6>
                                </div>
                            </div>
                      ...
                      <li class="d-flex mb-4 pb-1 align-items-center">
                        ...
                        <div class="d-flex w-100 align-items-center gap-2">
                           <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                                <div>
                                    <h6 class="mb-0">Downline Balance AEPS</h6>
                                </div>

                                
                                <div class="user-progress d-flex align-items-center gap-2">
                                    <h6 class="mb-0 aepsbalance">0</h6>
                                </div>
                            </div>
...
<div class="col-xl-4 col-md-6 mb-4">
    <div class="card h-100">
        ...
        <div class="card-body text-center">
            <div>
                <img src="{{ asset('') }}logos/helpdesk.jpg" {{-- "https://www.livermoreschools.org/cms/lib/CA50000061/Centricity/Domain/72/HelpDesk%20White%20C.png" --}} class="img-responsive mb-10" style="margin: auto; width: 200px">
            </div>
            ...
            <div class="form-group mb-3">
                <span class="text-semibold">
                    <h6><i class="fa fa-phone"></i> {{ $mydata['supportnumber'] }}</h6>
                    <small></small>
                </span>
            </div>
            ...
            <div class="form-group mb-3">
                <span class="text-semibold">
                    <h6><i class="fa fa-envelope"></i> {{ $mydata['supportemail'] }}</h6>
                    <small></small>
                </span>
            </div>
        </div>
...
@if (Myhelper::hasNotRole('admin'))
    @if (Auth::user()->kyc != 'pending' && Auth::user()->kyc != 'rejected' && Auth::user()->kyc != 'active')
    ...
    <div class="modal fade" id="kycModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="kycForm" action="{{ route('kycUpdate') }}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <select name="state" class="form-control select" required="">
                                    ...
                                    <option value="{{ $state->state }}" {{ Auth::user()->state == $state->state ? 'selected=""' : '' }}>
                                        {{ $state->state }}
                                    </option>
                                    @endforeach
                                </select>
