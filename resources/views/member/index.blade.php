        ...
        <div class="card">
            <div class="card-header pb-0 d-flex justify-content-between mb-lg-n4">
                ...
                <div class="col-sm-12 col-md-2 mb-5">
                    ...
                    @if (!Request::is('member/web') && !Request::is('member/kycsubmitted') && !Request::is('member/kycrejected') && !Request::is('member/kycpending'))
...
<div class="offcanvas offcanvas-end" id="upgrateModal" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static">
            ...
            <div class="offcanvas-body">
                ...
                <form id="upgrateForm" method="post" action="{{ route('profileUpdate') }}">
                    {!! csrf_field() !!}
        ...
        var options = [{
...

            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    @endif
                    @if(Myhelper::can(['member_account_statement_view']))
                    menu2 += `<a href="{{url('statement/commission/')}}/` + full.id + `" target="_blank" class="dropdown-item"><i class="icon-paragraph-justify3"></i> Commission Wallet</a>`;
                    @endif
                    
                    menu2 += `<a href="{{url('statement/ccledger/')}}/` + full.id + `" target="_blank" class="dropdown-item"><i class="icon-paragraph-justify3"></i> CC Statement</a>`;
                    // @if(Myhelper::can(['member_account_statement_view']))
                    // menu2 += `<a href="{{url('statement/reward/')}}/` + full.id + `" target="_blank" class="dropdown-item"><i class="icon-paragraph-justify3"></i> Reward Wallet</a>`;
                    // @endif
