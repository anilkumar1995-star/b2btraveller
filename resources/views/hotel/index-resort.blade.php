    ...
    <nav class="navbar navbar-dark navbar-expand-xl">
        <div class="container-fluid px-md-5">
            ...
            <a class="navbar-brand" href="{{ route('root') }}">
                <img class="navbar-brand-item" src="{{ asset('images/logo.png') }}" alt="logo">
            </a>
            <!-- Logo END -->
                ...
                <div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false"
                    ...
                    <div>
                        <div class="card card-metro overflow-hidden">
                            <img src="{{ asset('images/category/hotel/resort/3by4/01.jpg') }}" alt="">
                            <!-- Image overlay -->
                    ...
                    <div>
                        <div class="card card-metro overflow-hidden">
                            <img src="{{ asset('images/category/hotel/resort/3by4/02.jpg') }}" alt="">
                            <!-- Image overlay -->
                            <div class="card-img-overlay d-flex">
                                <!-- Info -->
                                <div class="card-text mt-auto">
                    ...
                    <div>
                        <div class="card card-metro overflow-hidden">
                            <img src="{{ asset('images/category/hotel/resort/3by4/03.jpg') }}" alt="">
                            <!-- Image overlay -->
                            <div class="card-img-overlay d-flex">
                                <!-- Info -->
                                <div class="card-text mt-auto">
                    ...
                    <div>
                        <div class="card card-metro overflow-hidden">
                            <img src="{{ asset('images/category/hotel/resort/3by4/04.jpg') }}" alt="">
                            <!-- Image overlay -->
                            <div class="card-img-overlay d-flex">
                                <!-- Info -->
                                <div class="card-text mt-auto">
                    ...
                    <div>
                        <div class="card card-metro overflow-hidden">
                            <img src="{{ asset('images/category/hotel/resort/3by4/05.jpg') }}" alt="">
                            <!-- Image overlay -->
                            <div class="card-img-overlay d-flex">
                                <!-- Info -->
                                <div class="card-text mt-auto">
                    ...
                    <div>
                        <div class="card card-metro overflow-hidden">
                            <img src="{{ asset('images/category/hotel/resort/3by4/06.jpg') }}" alt="">
                            <!-- Image overlay -->
                            <div class="card-img-overlay d-flex">
                                <!-- Info -->
                                <div class="card-text mt-auto">
                    ...
                    <div>
                        <div class="card card-metro overflow-hidden">
                            <img src="{{ asset('images/category/hotel/resort/3by4/07.jpg') }}" alt="">
                            <!-- Image overlay -->
                            <div class="card-img-overlay d-flex">
                                <!-- Info -->
                                <div class="card-text mt-auto">
            ...
            <div class="row g-4">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card bg-transparent h-100">
                        <img src="{{ asset('images/offer/02.jpg') }}" class="card-img" alt="">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card bg-transparent h-100">
                        <img src="{{ asset('images/offer/03.jpg') }}" class="card-img" alt="">
                        <div class="card-body text-center p-2">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card bg-transparent h-100">
                        <img src="{{ asset('images/offer/04.jpg') }}" class="card-img" alt="">
                        <div class="card-body text-center p-2">
        ...
        <div class="container-fluid px-lg-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-xl-5 mt-xl-auto">
                    <img src="{{ asset('images/category/hotel/resort/05.jpg') }}" class="rounded-3 align-items-bottom"
                        alt="">
                </div>
                                            ...
                                            <div class="p-4 p-lg-5">
                                                ...
                                                <div class="d-sm-flex justify-content-between align-items-bottom">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('images/avatar/05.jpg') }}" alt="avatar">
                                                        </div>
                                                        <!-- Info -->
                                                        <div class="ms-2">
                        ...
                        <div class="tiny-slider-inner rounded-2" data-autoplay="false" data-arrow="true"
                            ...
                            <div>
                                <a class="w-100 h-100" data-glightbox data-gallery="gallery"
                                    ...
                                    <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                        <!-- Image -->
                                        <img src="{{ asset('images/category/hotel/resort/06.jpg') }}" class="rounded-3"
                                            alt="">
                                        <!-- Full screen button -->
                            ...
                            <div>
                                <a class="w-100 h-100" data-glightbox data-gallery="gallery"
                                    ...
                                    <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                        <!-- Image -->
                                        <img src="{{ asset('images/category/hotel/resort/05.jpg') }}" class="rounded-3"
                                            alt="">
                                        <!-- Full screen button -->
                                        <div class="hover-element w-100 h-100">
                                            <i
                ...
                <div class="col-12">
                    <div class="bg-light position-relative overflow-hidden rounded-3 p-4 p-md-0">
                        ...
                        <div class="position-absolute bottom-0 end-0 me-n5 d-none d-md-block">
                            <img src="{{ asset('images/element/island.svg') }}" alt="">
                        </div>
    ...
    <div class="container">
        <div class="row mx-auto">
            <div class="col-lg-6 mx-auto text-center">
                <!-- Logo -->
                <img class="mx-auto h-60px" src="{{ asset('images/logo.png') }}" alt="logo">
                ...
                <!-- copyright text -->
                <div class="text-body-secondary text-primary-hover mt-3"> Copyrights ©2025 Booking. Build by <a
                        href="https://ipayments.in/" class="text-body-secondary">Ipayment</a>. </div>
            </div>
        </div>
