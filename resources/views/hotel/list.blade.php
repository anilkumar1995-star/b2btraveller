    ...
    <section class="pt-0">
        <div class="container">
            ...
            <div class="rounded-3 p-3 p-sm-5"
                style="background-image: url('{{ asset('images/bg/05.jpg') }}'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
                <!-- Banner title -->
                    ...
                    <div class="vstack gap-4">
                                ...
                                <div class="col-md-5 position-relative">
                                    ...
                                    <div class="tiny-slider arrow-round arrow-xs arrow-dark overflow-hidden rounded-2">
                                        <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true"
                                            ...
                                            <!-- Image item -->
                                            <div><img src="{{ asset('images/category/hotel/4by3/04.jpg') }}" alt="Card image"></div>
                        ...
                        <div class="card shadow p-2">
                            <div class="row g-0">
                                <!-- Card img -->
                                <div class="col-md-5">
                                    <img src="{{ asset('images/category/hotel/4by3/10.jpg') }}" class="card-img rounded-2"
                                        alt="Card image">
                                </div>
                        ...
                        <div class="card shadow p-2">
                            <div class="row g-0">
                                <!-- Card img -->
                                <div class="col-md-5">
                                    <img src="{{ asset('images/category/hotel/4by3/11.jpg') }}" class="card-img rounded-2"
                                        alt="Card image">
                                </div>
                                ...
                                <div class="col-md-5 position-relative">
                                    ...
                                    <div
                                        ...
                                        <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true"
                                            data-dots="false" data-items="1">
                                            <!-- Image item -->
                                            <div><img src="{{ asset('images/category/hotel/4by3/08.jpg') }}" alt="Card image">
                                            </div>

                                            <!-- Image item -->
                                            <div><img src="{{ asset('images/category/hotel/4by3/02.jpg') }}" alt="Card image">
                                            </div>

                                            <!-- Image item -->
                                            <div><img src="{{ asset('images/category/hotel/4by3/03.jpg') }}" alt="Card image">
                                            </div>

                                            <!-- Image item -->
                                            <div><img src="{{ asset('images/category/hotel/4by3/06.jpg') }}" alt="Card image">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Slider END -->
