            ...
            <div class="card bg-light overflow-hidden px-sm-5">
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-sm-3 text-end d-none d-sm-block">
                        <img src="{{ asset('images/element/17.svg') }}" class="mb-n4" alt="">
                    </div>
                </div>
            </div>
            <!-- Card END -->
                                ...
                                <div class="card mb-4">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <img src="{{ asset('images/category/hotel/4by3/02.jpg') }}" class="card-img"
                                                alt="">
                                        </div>
                                ...
                                <div class="bg-primary bg-opacity-10 rounded-3 mb-4 p-3">
                                    <div class="d-md-flex justify-content-md-between align-items-center">
                                        ...
                                        <div class="d-sm-flex align-items-center mb-2 mb-md-0">
                                            <!-- Image -->
                                            <img src="{{ asset('images/element/16.svg') }}" class="h-50px" alt="">
                                            <!-- Title -->
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between my-3">
                                                    ...
                                                    <ul class="list-inline my-0">
                                                        <li class="list-inline-item"> <a href="#"><img
                                                                    src="{{ asset('images/element/visa.svg') }}" class="h-30px"
                                                                    alt=""></a></li>
                                                        <li class="list-inline-item"> <a href="#"><img
                                                                    src="{{ asset('images/element/mastercard.svg') }}"
                                                                    class="h-30px" alt=""></a></li>
                                                        <li class="list-inline-item"> <a href="#"><img
                                                                    src="{{ asset('images/element/expresscard.svg') }}"
                                                                    class="h-30px" alt=""></a></li>
                                                    </ul>
                                                </div>
                                                ...
                                                <form class="row g-3">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="position-relative">
                                                            ...
                                                            <img src="{{ asset('images/element/visa.svg') }}"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="alert alert-success alert-dismissible fade show my-3"
                                                            ...
                                                            <div class="d-sm-flex align-items-center mb-3">
                                                                <img src="{{ asset('images/element/12.svg') }}"
                                                    ...
                                                    <ul class="list-inline mb-0">
                                                        ...
                                                        <li class="list-inline-item">
                                                            ...
                                                            <label class="btn btn-light btn-primary-soft-check"
                                                                for="option1">
                                                                <img src="{{ asset('images/element/13.svg') }}" class="h-20px me-2"
                                                                    alt="">Bank of America
                                                            </label>
                                                        </li>
                                                        <!-- Sale -->
                                                        <li class="list-inline-item">
                                                            ...
                                                            <label class="btn btn-light btn-primary-soft-check"
                                                                for="option2">
                                                                <img src="{{ asset('images/element/15.svg') }}" class="h-20px me-2"
                                                                    alt="">Bank of Japan
                                                            </label>
                                                        </li>
                                                        <!-- Buy -->
                                                        <li class="list-inline-item">
                                                            ...
                                                            <label class="btn btn-light btn-primary-soft-check"
                                                                for="option3">
                                                                <img src="{{ asset('images/element/14.svg') }}" class="h-20px me-2"
                                                                    alt="">VIVIV Bank
                                                            </label>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div id="collapse-3" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="card card-body border align-items-center text-center mt-4">
                                                    <!-- Image -->
                                                    <img src="{{ asset('images/element/paypal.svg') }}" class="h-70px mb-3"
                                                        alt="">
