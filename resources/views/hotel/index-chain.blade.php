                ...
                <div class="col-4">
                    ...
                    <a class="navbar-brand" href="{{ route('root') }}">
                        <img class="light-mode-item navbar-brand-item d-inline h-40px h-md-60px"
                            src="{{ asset('images/logo-hotel.svg') }}" alt="logo">
                        <img class="dark-mode-item navbar-brand-item d-inline h-40px h-md-60px"
                            src="{{ asset('images/logo-hotel-light.svg') }}" alt="logo">
                    </a>
                    <!-- Logo END -->
                </div>
                        ...
                        <ul class="nav border-bottom">
                            <li class="dropdown nav-item">
                                ...
                                <ul class="dropdown-menu dropdown-animation dropdown-menu-end min-w-auto"
                                    ...
                                    <li> <a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                src="{{ asset('images/flags/sp.svg') }}" alt="">Español</a> </li>
                                    <li> <a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                src="{{ asset('images/flags/fr.svg') }}" alt="">Français</a> </li>
                                    <li> <a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                src="{{ asset('images/flags/gr.svg') }}" alt="">Deutsch</a> </li>
                                </ul>
                            </li>
        ...
        <div class="container">
            ...
            <div class="tiny-slider arrow-round arrow-blur arrow-hover">
                <div class="tiny-slider-inner mb-8" data-autoplay="true" data-arrow="true" data-edge="2"
                    ...
                    <div>
                        <div class="card">
                            <img src="{{ asset('images/offer/06.jpg') }}" class="card-img" alt="">
                            <!-- Card body -->
                    ...
                    <div>
                        <div class="card">
                            <img src="{{ asset('images/offer/07.jpg') }}" class="card-img" alt="">
                            <!-- Card body -->
                            <div class="position-absolute top-100 start-50 translate-middle w-100">
                                <div class="card-body text-center bg-mode shadow rounded mx-4 p-3">
                    ...
                    <div>
                        <div class="card">
                            <img src="{{ asset('images/offer/08.jpg') }}" class="card-img" alt="">
                            <!-- Card body -->
                            <div class="position-absolute top-100 start-50 translate-middle w-100">
                                <div class="card-body text-center bg-mode shadow rounded mx-4 p-3">
                    ...
                    <div>
                        <div class="card">
                            <img src="{{ asset('images/offer/05.jpg') }}" class="card-img" alt="">
                            <!-- Card body -->
                            <div class="position-absolute top-100 start-50 translate-middle w-100">
                                <div class="card-body text-center bg-mode shadow rounded mx-4 p-3">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card  overflow-hidden">
                        <!-- Image -->
                        <img src="{{ asset('images/about/07.jpg') }}" class="rounded-3" alt="">
                        <!-- Full screen button -->
            ...
            <div class="row g-4 g-md-5">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/01.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/02.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/03.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/04.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/05.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/06.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/07.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/08.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/09.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/10.jpg') }}" class="rounded-circle" alt="">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{ asset('images/category/hotel/nearby/11.jpg') }}" class="rounded-circle" alt="">
                        ...
                        <div class="tiny-slider arrow-round arrow-blur">
                            <div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-edge="2"
                                ...
                                <div class="card bg-transparent">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm-6">
                                            <img src="{{ asset('images/category/flight/02.jpg') }}" class="img-fluid card-img"
                                                alt="...">
                                        </div>
                                        <div class="col-sm-6">
                                ...
                                <div class="card bg-transparent">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm-6">
                                            <img src="{{ asset('images/category/flight/01.jpg') }}" class="img-fluid card-img"
                                                alt="...">
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="card-body p-0">
                                ...
                                <div class="card bg-transparent">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm-6">
                                            <img src="{{ asset('images/category/flight/03.jpg') }}" class="img-fluid card-img"
                                                alt="...">
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="card-body p-0">
                ...
                <div class="tiny-slider-inner d-flex align-items-end" data-autoplay="true" data-edge="2"
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="/images/category/hotel/gallery/01.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/01.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="/images/category/hotel/gallery/02.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/02.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="/images/category/hotel/gallery/03.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/03.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="/images/category/hotel/gallery/05.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/05.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="/images/category/hotel/gallery/08.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/08.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="https://www.youtube.com/embed/tXHviS-4ygo">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/04.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <span
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="/images/category/hotel/gallery/06.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/06.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                    ...
                    <div>
                        <a data-glightbox="" data-gallery="gallery" href="/images/category/hotel/gallery/07.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="{{ asset('images/category/hotel/gallery/07.jpg') }}" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
