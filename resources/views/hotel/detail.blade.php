            ...
            <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button"
                        ...
                        aria-expanded="false">
                        <img class="avatar-img rounded-2" src="{{ asset('') }}/images/avatar/01.jpg" alt="avatar">
                    </a>
                        ...
                        <li class="px-3 mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar me-3">
                                    <img class="avatar-img rounded-circle shadow" src="{{ asset('') }}/images/avatar/01.jpg"
                                        alt="avatar">
                                </div>
                                <div>
                                    <a class="h6 mt-2 mt-sm-0" href="#">Lori Ferguson</a>
                                    <p class="small m-0">info@ipayments.org.in</p>
                                </div>
                            </div>
                        </li>
                                            ...
                                            <div class="col-md-5 position-relative">
                                                ...
                                                <div
                                                    ...
                                                    <div class="tiny-slider-inner" data-autoplay="true"
                                                        ...
                                                        <!-- Image item -->
                                                        <div><img src="{{ asset('images/category/hotel/4by3/04.jpg') }}"
                                                                alt="Card image"></div>

                                                        <!-- Image item -->
                                                        <div><img src="{{ asset('images/category/hotel/4by3/02.jpg') }}"
                                                                alt="Card image"></div>

                                                        <!-- Image item -->
                                                        <div><img src="{{ asset('images/category/hotel/4by3/03.jpg') }}"
                                                                alt="Card image"></div>

                                                        <!-- Image item -->
                                                        <div><img src="{{ asset('images/category/hotel/4by3/01.jpg') }}"
                                                                alt="Card image"></div>
                                                    </div>
                                                </div>
                                                <!-- Slider END -->
                            ...
                            <div class="card-body pt-4 p-0">
                                    ...
                                    <div>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-4 col-sm-3 col-lg-2">
                                                <img src="{{ asset('images/category/hotel/4by3/07.jpg') }}" class="rounded"
                                                    alt="">
                                            </div>
                                            <div class="col-4 col-sm-3 col-lg-2">
                                                <img src="{{ asset('images/category/hotel/4by3/08.jpg') }}" class="rounded"
                                                    alt="">
                                            </div>
                                            <div class="col-4 col-sm-3 col-lg-2">
                                                <img src="{{ asset('images/category/hotel/4by3/05.jpg') }}" class="rounded"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="my-4 ps-2 ps-md-3">
                                    <div class="d-md-flex p-3 bg-light rounded-3">
                                        <img class="avatar avatar-sm rounded-circle me-3" src="{{ asset('images/avatar/02.jpg') }}"
                                            alt="avatar">
                                ...
                                <div class="d-md-flex my-4">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-lg me-3 flex-shrink-0">
                                        <img class="avatar-img rounded-circle" src="{{ asset('images/avatar/08.jpg') }}"
                                            alt="avatar">
                                    </div>
                                    <!-- Text -->
                                    <div>
                            ...
                            <div class="card shadow rounded-3 overflow-hidden">
                                <div class="row g-0 align-items-center">
                                    ...
                                    <div class="col-sm-6 col-md-12 col-lg-6">
                                        <img src="{{ asset('images/offer/04.jpg') }}" class="card-img rounded-0" alt="">
                                    </div>
                ...
                <div class="card bg-transparent p-3">
                    ...
                    <div class="tiny-slider arrow-round arrow-dark overflow-hidden rounded-2">
                        <div class="tiny-slider-inner rounded-2 overflow-hidden" data-autoplay="true"
                            data-arrow="true" data-dots="false" data-items="1">
                            <!-- Image item -->
                            <div> <img src="{{ asset('images/gallery/16.jpg') }}" class="rounded-2" alt="Card image"></div>

                            <!-- Image item -->
                            <div> <img src="{{ asset('images/gallery/15.jpg') }}" class="rounded-2" alt="Card image"> </div>

                            <!-- Image item -->
                            <div> <img src="{{ asset('images/gallery/13.jpg') }}" class="rounded-2" alt="Card image"> </div>

                            <!-- Image item -->
                            <div> <img src="{{ asset('images/gallery/12.jpg') }}" class="rounded-2" alt="Card image"> </div>
                        </div>
                    </div>
                    <!-- Slider END -->
