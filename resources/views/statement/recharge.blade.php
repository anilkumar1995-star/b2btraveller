...
@section('content')
    <div class="row mt-4">
        <div class="col-12 col-xl-12 col-sm-12 order-1 order-lg-2 mb-4 mb-lg-0">
            <div class="card">
                <div class="card-header bg-light pb-1 d-flex justify-content-between mb-3">
    ...
    <div class="offcanvas offcanvas-end" id="utiidModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
