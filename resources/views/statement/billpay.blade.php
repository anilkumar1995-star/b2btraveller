        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                                ...
                                <tr>
                                    ...
                                    <th style="padding: 0px 0px 5px 0px; text-align: right; margin-right:10px">
                                        @if (Auth::user()->company->logo)
                                            <img src="https://ipayments.in/img/IPAYMNT.png" class="img-responsive"
                                                alt="" style="width: 100px;height: 40px;">
                                        @else
                    ...
                    <button class="btn btn-primary float-end" type="button" id="print"><i
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if (full.status == "success" || full.status == "pending") {
                            menu +=
                                `<li><a href="javascript:void(0)" class="dropdown-item print"><i class="icon-info22"></i>Print Invoice</a></li>`;
