                        ...
                        @if (@$export != null)
                            <div class="col-sm-12 col-md-3">
                                <div class="user-list-files d-flex float-right">
                                    ...
                                    <button type="button"
                                        class="btn btn-success  text-white mx-3 {{ isset($export) ? '' : 'hide' }}"
                                        product="{{ $export ?? '' }}" id="reportExport"> Export</button>
                                    ...
                                    <div class="d-flex gap-2 align-items-center dataTables_filter"
                                        ...
                                        <div class="row">
                                            ...
                                            @if (Myhelper::hasNotRole(['retailer', 'apiuser']))
                                                <div
                                                    class="form-group col-md-2 m-b-10 {{ isset($agentfilter) ? $agentfilter : '' }}">
