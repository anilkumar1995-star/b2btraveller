                        ...
                        <div class="row">
                            <div class="col">
                                @foreach ($depList->Benefits as $catList)
                                    <div>{{ $catList->id }}:-{{ $catList->name }}</div>
                                @endforeach

                                <div>Joining Fee : {{ $depList->opening_charge }}</div>
                                <div>Annual Fee : {{ $depList->annual_fee }}</div>
                                <div>Expected Earning : Earn upto{{ $depList->earning }}</div>
                                <div>Approval
                                    Rate:{{ $depList->earning == '0' ? 'No Rating' : ($depList->earning == '1' ? 'Excellent' : ($depList->earning == '2' ? 'Low' : ($depList->earning == '3' ? 'Good' : 'Unknown Rating'))) }}
                                </div>
                ...
                <form id="createVpaForm" action="{{ route('createvpa') }}" method="post">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label>State</label>
                                <input type="text" name="state" class="form-control my-1" placeholder="Enter state "
                                    required="">
                            </div>
                            <div class="form-group col-md-4">
                                <label>Pincode</label>
                                <input type="text" name="pincode" class="form-control my-1" placeholder="Enter pincode "
                                    required="">
                            </div>
                            <div class="form-group col-md-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                        onclick="getPDF('{{ $agent->vpaaddress ?? '' }}')">Download</button>
