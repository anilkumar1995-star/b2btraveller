...
<div class="offcanvas offcanvas-end" id="transferModal" role="dialog" data-bs-backdrop="static">
 
            <div class="offcanvas-header bg-primary"> 
                <h4 class="text-white">Fund Request From <span class="payeename text-capitalize"></span> </h4>
            ...
            <form id="transferForm" method="post" action="{{ route('fundtransaction') }}">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="offcanvas" aria-hidden="true">Close</button>
                    <button class="btn -primary" type="submit" data-loading-text="<i class='fa fa-spin fa-spinner'></i> Submitting">Submit</button>
                </div>
            </form>
...
<div class="offcanvas offcanvas-end" id="transferModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
            <div class="offcanvas-header bg-primary">
                <h4 class="text-white" id="exampleModalLabel">Fund Request From <span class="payeename text-capitalize"></span></h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "{{url('statement/fetch')}}/matmfundrequestviewall/0";
        var onDraw = function() {};
        var options = [{
                "data": "name",
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    if (full.status == "approved") {
                        var btn = '<span class="bg-success badge badge-success text-uppercase"><b>' + full.status + '</b></span>';
