@extends('layouts.app')
@section('title', 'Commission Settlement Details')
@section('pagetitle', 'Commission Settlement Details')
...
<div class="offcanvas offcanvas-end " id="fundRequestModalsRunpaisa" tabindex="-1" role="modal" aria-labelledby="exampleModalLabels" aria-hidden="true" data-bs-backdrop="static">
    ...
    <form id="fundRequestFormsRunpaisa" action="{{ route('fundtransaction') }}" method="post">
        <div class="offcanvas-body">
            <input type="hidden" name="user_id">
            {{ csrf_field() }}
            @if (Auth::user()->userbanks['accountNo'] == '' || Auth::user()->userbanks['accountNo'] == null)
            <div class="row">
                <div class="form-group col-md-12 my-1 my-1">
                    <label>Remarks <span class="text-danger fw-bold">*</span></label>
                    <input type="text" class="form-control my-1" name="remarks" placeholder="Enter Value" required="" value="{{ print 'Please add Bank Account for commission settlement' }}" readonly>
                </div>
            </div>
            @else
            <div class="row">
                <div class="form-group col-md-6 my-1 my-1">
                    ...
                    <input type="text" class="form-control my-1" name="account" placeholder="Enter Value" required="" value="{{ Auth::user()->userbanks['accountNo'] }}" readonly>
                </div>
                <div class="form-group col-md-6 my-1 my-1">
                    <label>IFSC Code <span class="text-danger fw-bold">*</span></label>
                    <input type="text" class="form-control my-1" name="ifsc" placeholder="Enter Value" required="" value="{{ Auth::user()->userbanks['ifscCode'] }}" readonly>
                </div>
                <div class="form-group col-md-6 my-1 my-1">
                    <label>Bank Name <span class="text-danger fw-bold">*</span></label>
                    <input type="text" class="form-control my-1" name="bank" placeholder="Enter Value" required="" value="{{ Auth::user()->userbanks['bankName'] }}" readonly>
                </div>
                <div class="form-group col-md-6 my-1 my-1">
...
<div class="offcanvas offcanvas-end" id="fundRequestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <form id="fundRequestForms" action="{{ route('fundtransaction') }}" method="post">
        <div class="offcanvas-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "{{ url('statement/fetch') }}/commissionsettlement/0";
        var onDraw = function() {};
        var options = [{
                "data": "name",
