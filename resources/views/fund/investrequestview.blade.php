...
<div id="transferModal" class="modal fade" data-bs-backdrop="static" data-keyboard="false">
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `<div class="btn-group" role="group">
                                    <span id="btnGroupDrop1" class="badge ${full.status=='approved'? 'badge-success' : full.status=='pending'? 'badge-warning':'badge-danger'} dropdown-toggle"  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ` + full.status + `
                                    </span>
                                    <div class="dropdown-menu" style="height:180px;" aria-labelledby="btnGroupDrop1">
                                       ` + menu + `
                                    </div>
                                 </div>`;
