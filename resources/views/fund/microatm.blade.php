            ...
            <div class="card-header pb-0 d-flex justify-content-between mb-lg-n4 ">
                ...
                <div class="col-sm-12 col-md-2 mb-5">
                    <div class="user-list-files d-flex float-right">
                        <button class="btn btn-success text-white ms-2" data-bs-toggle="offcanvas" data-bs-target="#fundRequestModal">
                            New Request</button>
                    </div>
                </div>
            </div>
...
<div class="offcanvas offcanvas-end" id="fundRequestModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
            ...
            <div class="offcanvas-header bg-primary">
                <div class="text-center">
                    <h4 class="text-white">Micro ATM Fund Request</h4>
                </div>
                ...
                <form id="fundRequestForm" action="{{route('fundtransaction')}}" method="post">
                    <div class="offcanvas-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>T-Pin</label>
                                <input type="number" class="form-control" name="pin" placeholder="Enter Value" required="">
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "{{url('statement/fetch')}}/matmfundrequest/0";
        var onDraw = function() {};
        var options = [{
                "data": "name",
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    if (full.status == "approved") {
                        var btn = '<span class="badge badge-success text-uppercase bg-success"><b>' + full.status + '</b></span>';
                    } else if (full.status == 'pending') {
                        var btn = '<span class="badge badge-warning text-uppercase bg-warning"><b>' + full.status + '</b></span>';
                    } else {
                        var btn = '<span class="badge badge-danger text-uppercase bg-danger"><b>' + full.status + '</b></span>';
                    }
                    return btn;
                }
            }
