@extends('layouts.app')
@section('title', 'CC Settlement Details')
@section('pagetitle', 'CC Settlement Details')
        ...
        <div class="offcanvas-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 my-1 my-1 accountdetails">
                    ...
                    <input type="text" class="form-control my-1" name="account" placeholder="Enter Value"  value="{{ Auth::user()->userbanks['accountNo'] }}" >
                </div>
                ...
                <div id="receptTable">
                    <div class="clearfix">
                        <div class="text-center">
                             <img src="{{asset('public/recept.jpeg')}}" class=" img-responsive" alt="" style="width: 70px;height: 50px;">
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#bank').on('change', function (e) {
        ...
        var url = "{{ url('statement/fetch') }}/ccfundsettlement/0";
         var onDraw = function() {
       ...
       var DT  =  datatableSetup(url, options, onDraw);
        ...
        $("#fundRequestFormsRunpaisa").validate({
          ...
          $('#getBenename').click(function(){
            ...
            var benemobile = "{{Auth::user()->mobile}}";
            if(type == "ccbank"){
