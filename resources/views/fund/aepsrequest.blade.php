                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        if (full.option1 == "wallet") {
                            return "Fund Settle in WALLET <br>" + "Settlement Mode: " + full.option2
                                .toUpperCase();
                        } else {
                            return "Fund Settle in BANK <br>" + "Settlement Mode: " + full.option2
                                .toUpperCase() + "<br> A/C No.: " + full.number + "<br> IFSC: " + full
                                .option4;
                        }
                    }
                },
