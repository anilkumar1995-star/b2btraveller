                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        @if (isset($bank->fund_qr))
                                            <div>QR : <a target="_blank" href="{{ Imagehelper::getImageUrl().$bank->fund_qr }}">SCAN QR (Click to Scan & Pay)</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
            ...
            var options = [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        var slip = '';
                        if (full.payslip) {
                            var slip = `<a target="_blank" href={{ Imagehelper::getImageUrl() }}`+full.payslip +`>Pay Slip</a>`
                        }
